...
import net.smile.smilemod.item.ModItems;
...
public class SmileMod {
    ...
    public static final String MOD_ID = "smilemod";
    ...
    public SmileMod(FMLJavaModLoadingContext context) {
